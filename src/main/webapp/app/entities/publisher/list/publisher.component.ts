...
export class PublisherComponent implements OnInit {
  ...
  trackId = (item: IPublisher): number => this.publisherService.getPublisherIdentifier(item);
      ...
      .pipe(
        ...
        tap(() => {
          if (this.publishers().length === 0) {
            ...
            this.publishers.set(this.refineData(this.publishers()));
          }
        }),
      )
      .subscribe();
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.publishers.set(this.refineData(dataFromBody));
  }
