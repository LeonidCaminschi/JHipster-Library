...
import { sampleWithRequiredData } from '../borrowed-book.test-samples';
...
describe('BorrowedBook Management Component', () => {
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.borrowedBooks()[0]).toEqual(expect.objectContaining({ id: 10580 }));
  });

  describe('trackId', () => {
    it('Should forward to borrowedBookService', () => {
      const entity = { id: 10580 };
