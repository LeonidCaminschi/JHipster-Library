...
import static com.esempla.library.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    public static Client createEntity() {
        return new Client().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME).address(DEFAULT_ADDRESS).phone(DEFAULT_PHONE);
    }
    ...
    public static Client createUpdatedEntity() {
        return new Client().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
    }
    ...
    void putExistingClient() throws Exception {
        ...
        updatedClient.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.firstName(UPDATED_FIRST_NAME).address(UPDATED_ADDRESS);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
